<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="TB_CARTEIRA_Grid.aspx.cs" Inherits="PROJETO.DataPages.TB_CARTEIRA_Grid" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TB_CARTEIRA_Grid.css" OrderIndex="2"/>
		</StyleSheets>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_CARTEIRA_Grid_USER.js??sv=1.0_20221122174320") %>"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/carteira") %>';
			UrlPage += "/incluir";
			NavigateBrowser(UrlPage);
			args.set_cancel(true);
			return false;
		}
		function GridColumn_CAR_NOME_Validation(field, rules, i, options) {
							...
							<div id="LayoutCol11" class="col col-12 c_LayoutCol11">
								<div id="LayoutRow3" class="row c_LayoutRow3 card flex-row">
									<div id="LayoutCol9" class="col col-12 c_LayoutCol9 card-header">
										<div id="LayoutRow6" class="row c_LayoutRow6">
											<div id="LayoutCol19" class="col col-9 c_LayoutCol19">
												...
												<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Lista de Carteira" />
											</div>
									...
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="Grid_TB_CARTEIRA" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True"
											AllowSorting="True" AutoGenerateColumns="false" CssClass="c_Grid_TB_CARTEIRA grid-default" CleanLayoutNoRecord="True"
											...
											OnInsertCommand="Grid_InsertCommand" OnItemCommand="Grid_TB_CARTEIRA_ItemCommand" OnItemCreated="Grid_TB_CARTEIRA_ItemCreated"
											OnItemDataBound="Grid_TB_CARTEIRA_ItemDataBound" OnNeedDataSource="Grid_NeedDataSource" OnPreRender="Grid_TB_CARTEIRA_PreRender"
											OnUpdateCommand="Grid_UpdateCommand" PageSize="10" RenderMode="Lightweight" ShowFooter="False" ShowGroupPanel="False" TabIndex="4"
											TableLayout="Fixed">
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="CAR_ID" EditMode="InPlace" OnPreRender="Grid_TB_CARTEIRA_PreRender">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn_CAR_NOME" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="CAR_NOME" EnableHeaderContextMenu="True" Exportable="True"
														FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_CAR_NOME"
														HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_CAR_NOME %>" ItemStyle-CssClass="c_GridColumn_CAR_NOME"
													...
													<telerik:GridButtonColumn Exportable="false" HeaderStyle-Width="25" ConfirmText="Deseja excluir o registro?" ConfirmDialogType="RadWindow" ConfirmTitle="Deletar" ButtonType="ImageButton" CommandName="Delete" UniqueName="Grid_TB_CARTEIRA_DeleteColumn"/>
												</Columns>
