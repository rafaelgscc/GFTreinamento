<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="TB_CONFIGURACOES.aspx.cs" Inherits="PROJETO.DataPages.TB_CONFIGURACOES" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TB_CONFIGURACOES.css" OrderIndex="2"/>
		</StyleSheets>
	...
	<telerik:RadCodeBlock ID="HeaderCodeBlock" runat="server">
		...
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/bootstrap5.min.css??sv=1.0_20221129105948") %>" type="text/css" media="screen" title="no title"/>
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/all.min.css??sv=1.0_20221129105948") %>" type="text/css" media="screen" title="no title"/>  	
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/gvbaselayout.css??sv=1.0_20221129105948") %>" type="text/css" media="screen" title="no title"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlertEditar(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_CONFIGURACOES_USER.js??sv=1.0_20221129105949") %>"></script>
									...
									<div id="LayoutCol23" class="col col-12 c_LayoutCol23 card-header">
										<div id="LayoutRow8" class="row c_LayoutRow8">
											<div id="LayoutCol25" class="col col-12 c_LayoutCol25">
												...
												<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Configurações" />
											</div>
										</div>
									</div>
									<div id="LayoutCol21" class="col col-12 c_LayoutCol21 card-body">
										<div id="LayoutRow7" class="row c_LayoutRow7">
											<div id="LayoutCol29" class="col col-12 col-md-6 c_LayoutCol29">
												<telerik:RadLabel id="Label_CONFIG_CONTA_TRANSF_PADRAO" runat="server" CssClass="c_Label_CONFIG_CONTA_TRANSF_PADRAO"
													Text="<%$ Resources: Label_CONFIG_CONTA_TRANSF_PADRAO %>" />
												<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													...
													data-validation-engine="validate[funcCall[ComboBox1_Validation]]"
													data-validation-message="Conta padrão para transferências não pode ser vazio!" EnableEmbeddedSkins="True" EnableLoadOnDemand="True"
													EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None" ForeColor="#292828"
													LoadingMessage="<%$ Resources: ComboBox1 %>" MarkFirstMatch="true" MaxHeight="100" OnClientBlur="___ComboBox1_OnBlur"
											...
											<div id="LayoutCol30" class="col col-12 col-md-6 c_LayoutCol30">
												<telerik:RadLabel id="Label_CONFIG_CARTEIRA_PADRAO" runat="server" CssClass="c_Label_CONFIG_CARTEIRA_PADRAO"
													Text="<%$ Resources: Label_CONFIG_CARTEIRA_PADRAO %>" />
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function CONFIG_CONTA_TRANSF_PADRAO() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function CONFIG_CARTEIRA_PADRAO() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
