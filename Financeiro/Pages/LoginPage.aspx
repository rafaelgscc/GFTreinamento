...
<head runat="server">
	...
	<telerik:RadCodeBlock ID="HeaderCodeBlock" runat="server">
		<link rel="stylesheet" href="<%= ResolveUrl("~/Styles/validationEngine.jquery.css??sv=1.0_20221129105950") %>" type="text/css" media="screen" title="no title"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/Functions.js??sv=1.0_20221129105950") %>"></script>
			...
			<script type="text/javascript" src="<%= ResolveUrl("~/JS/LoginPage_USER.js??sv=1.0_20221129105950") %>"></script>
