<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="TB_CONTA_Grid.aspx.cs" Inherits="PROJETO.DataPages.TB_CONTA_Grid" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TB_CONTA_Grid.css" OrderIndex="2"/>
		</StyleSheets>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_CONTA_Grid_USER.js??sv=1.0_20221129105950") %>"></script>
	...
	<script type="text/javascript">
		...
		function GridColumn_CT_NOME_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function GridColumn_GC_ID_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
							...
							<div id="LayoutCol11" class="col col-12 c_LayoutCol11">
								<div id="LayoutRow3" class="row c_LayoutRow3 card flex-row">
									<div id="LayoutCol9" class="col col-12 c_LayoutCol9 card-header">
										<div id="LayoutRow6" class="row c_LayoutRow6">
											<div id="LayoutCol19" class="col col-9 c_LayoutCol19">
												...
												<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Lista de Conta" />
											</div>
									...
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="Grid_TB_CONTA" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True"
											AllowSorting="True" AutoGenerateColumns="false" CssClass="c_Grid_TB_CONTA grid-default" CleanLayoutNoRecord="True"
											...
											OnInsertCommand="Grid_InsertCommand" OnItemCommand="Grid_TB_CONTA_ItemCommand" OnItemCreated="Grid_TB_CONTA_ItemCreated"
											OnItemDataBound="Grid_TB_CONTA_ItemDataBound" OnNeedDataSource="Grid_NeedDataSource" OnPreRender="Grid_TB_CONTA_PreRender"
											OnUpdateCommand="Grid_UpdateCommand" PageSize="10" RenderMode="Lightweight" ShowFooter="False" ShowGroupPanel="False" TabIndex="4"
											TableLayout="Fixed">
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" EditMode="InPlace" OnPreRender="Grid_TB_CONTA_PreRender">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn_CT_NOME" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														HeaderStyle-Width="161" HeaderText="<%$ Resources: GridColumn_CT_NOME %>" ItemStyle-CssClass="c_GridColumn_CT_NOME"
														ItemStyle-Width="154" MaxLength="100" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridTemplateColumn UniqueName="GridColumn_GC_ID" runat="server" AllowFiltering="True" AutoPostBackOnFilter="False"
														ConvertEmptyStringToNull="False" DataField="GC_ID" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%"
														FilterDelay="2000" ForceExtractValue="Always" GroupByExpression="GC_ID GC_ID Group By GC_ID" HeaderStyle-CssClass="c_GridColumn_GC_ID"
														HeaderStyle-Width="134" HeaderText="<%$ Resources: GridColumn_GC_ID %>" ItemStyle-CssClass="c_GridColumn_GC_ID" ItemStyle-Width="127"
														ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" SortExpression="GC_ID">
														<EditItemTemplate>
															<telerik:RadComboBox RenderMode="Lightweight" ID="GridColumn_GC_ID_ComboBox" runat="server" MarkFirstMatch="True" AllowCustomText="False" 
																...
																OnClientBlur="ValidateCombo" data-validation-engine="validate[funcCall[GridColumn_GC_ID_Validation]]" data-validation-message="ID do Grupo não pode ser vazio!"
																OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___Grid_TB_CONTA_GridColumn_GC_ID_ComboBox_OnItemsRequested" ItemsPerRequest="15"
																Width="119" ClientIDMode="Static" />
														</EditItemTemplate>
														<ItemTemplate> 
															<asp:Label runat="server" ID="GridColumn_GC_ID_Label" Text='<%#PageProvider.TB_CONTA_Grid_Grid_TB_CONTAProvider.GetGridComboText("GridColumn_GC_ID", Eval("GC_ID").ToString())%>' Value='<%#Eval("GC_ID").ToString()%>'/>
														</ItemTemplate> 
													...
													<telerik:GridButtonColumn Exportable="false" HeaderStyle-Width="25" ConfirmText="Deseja excluir o registro?" ConfirmDialogType="RadWindow" ConfirmTitle="Deletar" ButtonType="ImageButton" CommandName="Delete" UniqueName="Grid_TB_CONTA_DeleteColumn"/>
												</Columns>
