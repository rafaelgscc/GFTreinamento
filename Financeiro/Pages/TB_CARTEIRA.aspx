<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="TB_CARTEIRA.aspx.cs" Inherits="PROJETO.DataPages.TB_CARTEIRA" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TB_CARTEIRA.css" OrderIndex="2"/>
		</StyleSheets>
...
<script type="text/javascript">
	...
	function sweetAlert_SweetAlertEditar(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_CARTEIRA_USER.js??sv=1.0_20221129105950") %>"></script>
	...
	<script type="text/javascript">
		...
		function ___RadTextBox_CAR_NOME_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		...
		function RadTextBox_CAR_NOME_Validation(field, rules, i, options) {
									...
									<div id="LayoutCol23" class="col col-12 c_LayoutCol23 card-header">
										<div id="LayoutRow8" class="row c_LayoutRow8">
											<div id="LayoutCol25" class="col col-12 c_LayoutCol25">
												...
												<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Detalhes de Carteira" />
											</div>
										</div>
									</div>
									<div id="LayoutCol21" class="col col-12 c_LayoutCol21 card-body">
										<div id="LayoutRow7" class="row c_LayoutRow7">
											<div id="LayoutCol29" class="col col-12 col-md-6 c_LayoutCol29">
												<telerik:RadLabel id="Label_CAR_NOME" runat="server" CssClass="c_Label_CAR_NOME" Text="<%$ Resources: Label_CAR_NOME %>" />
												<telerik:RadTextBox id="RadTextBox_CAR_NOME" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_CAR_NOME textbox-default"
													data-validation-engine="validate[funcCall[RadTextBox_CAR_NOME_Validation]]"
													data-validation-message="Nome da Carteira não pode ser vazio!" EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True"
													ForeColor="#333333" MaxLength="100" onkeydown="___RadTextBox_CAR_NOME_onkeydown();" ReadOnly="False" RenderMode="Lightweight"
													TabIndex="1" TextMode="SingleLine" WrapperCssClass="c_RadTextBox_CAR_NOME_wrapper" />
											</div>
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#RadTextBox_CAR_NOME').first().focus();", 200);
				}
			}
			catch (e)
			{
		...
		function CAR_NOME() { return document.getElementById('RadTextBox_CAR_NOME').value; }
		...
		function LoadEditAuto() {
				$j("#RadTextBox_CAR_NOME").bind("keydown", InitiateEditAuto);
		}
