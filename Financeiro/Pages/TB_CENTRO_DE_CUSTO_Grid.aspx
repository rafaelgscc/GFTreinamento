<%@ Page Language="C#" ValidateRequest="false" EnableEventValidation="True" AutoEventWireup="true" CodeFile="TB_CENTRO_DE_CUSTO_Grid.aspx.cs" Inherits="PROJETO.DataPages.TB_CENTRO_DE_CUSTO_Grid" Culture="auto" UICulture="auto"%>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TB_CENTRO_DE_CUSTO_Grid.css" OrderIndex="2"/>
		</StyleSheets>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="<%= ResolveUrl("~/JS/TB_CENTRO_DE_CUSTO_Grid_USER.js??sv=1.0_20221129105950") %>"></script>
	...
	<script type="text/javascript">
		...
		function GridColumn_CC_NOME_Validation(field, rules, i, options) {
							...
							<div id="LayoutCol11" class="col col-12 c_LayoutCol11">
								<div id="LayoutRow3" class="row c_LayoutRow3 card flex-row">
									<div id="LayoutCol9" class="col col-12 c_LayoutCol9 card-header">
										<div id="LayoutRow6" class="row c_LayoutRow6">
											<div id="LayoutCol19" class="col col-9 c_LayoutCol19">
												...
												<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Lista de Centro de Custo" />
											</div>
									...
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="Grid_TB_CENTRO_DE_CUSTO" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True"
											AllowSorting="True" AutoGenerateColumns="false" CssClass="c_Grid_TB_CENTRO_DE_CUSTO grid-default" CleanLayoutNoRecord="True"
											...
											OnInsertCommand="Grid_InsertCommand" OnItemCommand="Grid_TB_CENTRO_DE_CUSTO_ItemCommand"
											OnItemCreated="Grid_TB_CENTRO_DE_CUSTO_ItemCreated" OnItemDataBound="Grid_TB_CENTRO_DE_CUSTO_ItemDataBound"
											OnNeedDataSource="Grid_NeedDataSource" OnPreRender="Grid_TB_CENTRO_DE_CUSTO_PreRender" OnUpdateCommand="Grid_UpdateCommand" PageSize="10"
											RenderMode="Lightweight" ShowFooter="False" ShowGroupPanel="False" TabIndex="4" TableLayout="Fixed">
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="CC_ID" EditMode="InPlace" OnPreRender="Grid_TB_CENTRO_DE_CUSTO_PreRender">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn_CC_NOME" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="CC_NOME" EnableHeaderContextMenu="True" Exportable="True"
														FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_CC_NOME"
														HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_CC_NOME %>" ItemStyle-CssClass="c_GridColumn_CC_NOME" ItemStyle-Width="86"
													...
													<telerik:GridButtonColumn Exportable="false" HeaderStyle-Width="25" ConfirmText="Deseja excluir o registro?" ConfirmDialogType="RadWindow" ConfirmTitle="Deletar" ButtonType="ImageButton" CommandName="Delete" UniqueName="Grid_TB_CENTRO_DE_CUSTO_DeleteColumn"/>
												</Columns>
